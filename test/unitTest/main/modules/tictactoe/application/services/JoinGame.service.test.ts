...
import { IJoinGameRequest, IJoinGameService } from '../../../../../../../src/modules/tictactoe/application/ports/input/IJoinGame.service'
...
describe('JoinGameService - Tests', () => {
  ...
  describe('JoinGameService - failed cases', () => {
    ...
    describe('JoinGameService - failed case when obtaining gane has not found the player in the system', () => {
      beforeEach(() => {
        jest.spyOn(PlayerMemoryRepository.prototype, 'getOneById').mockResolvedValue(right(PLAYER_X))
      ...
      it('JoinGameService - failed case when obtaining gane has not found the player in the system', async () => {
        // Arrange
        const request: IJoinGameRequest = {
          userCredential: PLAYER_X_CREDENTIALS,
          idGame: DEFAULT_UNIQUE_ID,
